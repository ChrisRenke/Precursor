...
public class inPlayMenuS : MonoBehaviour {
	...
	public static UpgradeMenuS script;
	//Menu backboards
	...
	void Awake()
	{
		...
		script =  GetComponent<UpgradeMenuS>();
...
//			displayObjectiveUpgradeMenu();
//	 	}
	}
	
	public static void displayObjectiveUpgradeMenu(){
		//disable enemy health bars
		disableEnemyHealthBars();
		//pause the game
    	Time.timeScale = 0;
	...
	public static void displayMechUpgradeMenu(){
		//disable enemy health bars
		disableEnemyHealthBars();
		//pause the game
		Time.timeScale = 0;
	...
	public static void displayTownUpgradeMenu(){
		//disable enemy health bars
		disableEnemyHealthBars();
		//pause the game
		Time.timeScale = 0;
